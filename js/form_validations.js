    ...
    $('#rootwizard').bootstrapWizard({
        ...
        'onNext': function (tab, navigation, index) {
            ...
            if (!$valid) {
                ...
                pasos = document.getElementsByClassName("paso").length;
                completados = document.getElementsByClassName("complete").length;
                terminos = document.getElementById("checkbox1");
                datos = document.getElementsByName("campos_correo");

                if (completados > 1) {

                    if (!terminos.checked) {
                        alert("Debe aceptar los términos de uso para continuar");
                        $('#rootwizard').find('.form-wizard').children('li').eq(index - 1).find('.step').html('2');
                        $validator.focusInvalid();
                        return false;
                    }
                }
                ...
                campos_correo = 0;
                // Los dos campos para formar el correo institucional marcados
                if (completados > 2) {
                ...
                if (pasos == completados) {
                    ...
                    /*if (campos_correo == 2) {
                     ...
                     if (document.getElementsByName("desbloquear")[0].value == 0) {
                     $("#commentForm").submit();
                     } else {
                     alert("Debe seleccionar dos campos para formar su correo institucional");
                     }
                     }*/
                }
            }
