    ...
    var Mapplic = function () {
        ...
        function Sidebar() {
            ...
            this.init = function () {
                ...
                if (!self.o.search)
                    listContainer.css('padding-top', '0');
            }
            ...
            this.addCategories = function (categories) {
                ...
                $.each(categories, function (index, category) {
                    ...
                    if (category.icon)
                        $('<img>').attr('src', category.icon).addClass('mapplic-list-thumbnail').prependTo(link);
            ...
            if (data.levels) {
                $.each(data.levels, function (index, value) {
                    ...
                    $.each(value.locations, function (index, value) {
                        ...
                        if (self.sidebar)
                            self.sidebar.addLocation(value);
                    });
