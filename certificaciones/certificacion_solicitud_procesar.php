...
if (isset($_SESSION[usuario])) {
    ...
    if (DB::isError($db)) {
        ...
        for ($i = 0; $i < $cantidad; $i++) {
            ...
            (anio, listado, carnet, carrera, no_reporte, entidad, fecha_solicitud)
            VALUES (
                $anio,
				1,
                $carnet,
        ...
        if (!$error) {
            ...
            $proceso_finalizado = "Se ha registrado la solicitud de certificación, para confirmar el pago por favor dirijase a la ventanilla de tesorería.";
            $_SESSION['proceso_finalizado'] = $proceso_finalizado;
            echo "
                <script>
                    window.open('../certificaciones/certificacion_solicitud_formulario.php','contenido');
                </script>
            ";
        }
