...
$fecha_habilitar_ext = ["2023-07-20 06:00", "2023-07-20 13:00"];

$fecha_activa_asigext = "2024-07-18 06:00";
$fecha_desactiva_asigext = "2024-07-18 12:00";
...
if (isset($_SESSION[usuario])) {
    ...
    if (DB::isError($db)) {
		...
		WHERE o.anio = $anio AND o.carnet = $carnet AND o.no_boleta_deposito IS NULL AND rubro = 9";
                ...
                if ($db->isError($ordenes_pago)) {
                    ...
                    if ($db->isError($proyecto_graduacion)) {
                        ...
                        if ($db->isError($inscripcion_arq)) {
                            ...
                            $fecha_habilita_encuesta = "2024-06-27 06:00";
                            $fecha_desabilita_encuesta = "2024-06-27 23:59";
			    ...
			    AND a.carnet = $carnet AND a.status = 1 AND a.extension in (0, 12) 
                            AND NOT EXISTS(
                                SELECT 1
        ...
        if (!$error) {
            ...
            if (DATE("o-m-d H") >= $fecha_activa_asigext && DATE("o-m-d H") <= $fecha_desactiva_asigext || $carnet == 202099999) {
