...
class HTML2PDF_myPdf extends TCPDF {
    ...
    $x = null, $y = null, $w = null, $h = null, $cornerTL = null, $cornerTR = null, $cornerBL = null, $cornerBR = null) {
        // init the path
        $path = '';
    ...
    $xc, $yc, $rx, $ry, $angleBegin, $angleEnd, $direction = true, $drawFirst = true, $trans = false) {
        ...
        for ($i = 1; $i <= self::ARC_NB_SEGMENT; $i++) {
            ...
            $this->_Curve(
                    $a0 + ($c0 * $dtm), $b0 + ($d0 * $dtm), $a1 - ($c1 * $dtm), $b1 - ($d1 * $dtm), $a1, $b1, $trans
            );
    ...
    &$obj, $titre = 'Index', $sizeTitle = 20, $sizeBookmark = 15, $bookmarkTitle = true, $displayPage = true, $page = null, $fontName = 'helvetica') {
