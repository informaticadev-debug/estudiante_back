...
' . $content . '
        ...
        protected function _DEBUG_add($name, $level = null) {
            ...
            $this->_DEBUG_stepline(
                    $name, number_format(($time - $this->_debugStartTime) * 1000, 1, '.', ' ') . ' ms', number_format(($time - $this->_debugLastTime) * 1000, 1, '.', ' ') . ' ms', number_format($usage / 1024, 1, '.', ' ') . ' Ko', number_format($peak / 1024, 1, '.', ' ') . ' Ko'
            );
        ...
        protected function _prepareSubObj() {
            ...
            HTML2PDF::$_subobj = new HTML2PDF(
                    $this->_orientation, $this->_format, $this->_langue, $this->_unicode, $this->_encoding, array($this->_defaultLeft, $this->_defaultTop, $this->_defaultRight, $this->_defaultBottom)
            );
        ...
        protected function _createSubHTML(&$subHtml, $cellmargin = 0) {
            ...
            $subHtml->initSubHtml(
                    $this->_format, $this->_orientation, $marge, $this->_page, $this->_defList, $this->pdf->getMyLastPageGroup(), $this->pdf->getMyLastPageGroupNb()
            );
        }
        ...
        protected function _tag_open_DIV($param, $other = 'div') {
            ...
            $this->_drawRectangle(
                    $this->parsingCss->value['x'], $this->parsingCss->value['y'], $this->parsingCss->value['width'], $this->parsingCss->value['height'], $this->parsingCss->value['border'], $this->parsingCss->value['padding'], 0, $this->parsingCss->value['background']
            );
            ...
            if ($overflow) {
                ...
                $this->pdf->clippingPathStart(
                        $this->parsingCss->value['x'] + $marge['l'], $this->parsingCss->value['y'] + $marge['t'], $this->parsingCss->value['width'], $this->parsingCss->value['height']
                );
        ...
        protected function _tag_open_TABLE($param, $other = 'table') {
            ...
            if ($this->_subPart) {
                ...
                $this->_drawRectangle(
                        HTML2PDF::$_tables[$param['num']]['curr_x'], HTML2PDF::$_tables[$param['num']]['curr_y'], HTML2PDF::$_tables[$param['num']]['width'], isset(HTML2PDF::$_tables[$param['num']]['height'][0]) ? HTML2PDF::$_tables[$param['num']]['height'][0] : null, $this->parsingCss->value['border'], $this->parsingCss->value['padding'], 0, $this->parsingCss->value['background']
                );
        ...
        protected function _tag_open_TD($param, $other = 'td') {
            ...
            if ($this->_subPart) {
                ...
                $this->_drawRectangle(
                        HTML2PDF::$_tables[$param['num']]['td_x'], HTML2PDF::$_tables[$param['num']]['td_y'], HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['w'], HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['h'], $this->parsingCss->value['border'], $this->parsingCss->value['padding'], HTML2PDF::$_tables[$param['num']]['cellspacing'] * 0.5, $this->parsingCss->value['background']
                );
