...
class Google_Service_Resource {
    ...
    public function call($name, $arguments, $expected_class = null) {
        ...
        $url = Google_Http_REST::createRequestUri(
                        $this->servicePath, $method['path'], $parameters
        );
        $httpRequest = new Google_Http_Request(
                $url, $method['httpMethod'], null, $postBody
        );
        ...
        if (isset($parameters['data']) &&
            ...
            $mfu = new Google_Http_MediaFileUpload(
                    $this->client, $httpRequest, isset($parameters['mimeType']) ? $parameters['mimeType']['value'] : 'application/octet-stream', $parameters['data']['value']
            );
        }
