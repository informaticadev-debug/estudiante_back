...
if (isset($_SESSION[usuario])) {
    ...
    if (DB::isError($db)) {
        ...
        GROUP BY i.carrera";
       // if ($carnet == 201430899 ) {var_dump($consulta); die;}
                                ...
                                if ($ciclo == 0) {
                                    ...
                                    if ($ciclo[fecha_inicio_asignacion] > $ciclo[fecha_actual] && !in_array($carnet, $habilitarCarnet)) {
                                        ...
                                        if ($ciclo[fecha_fin_asignacion] < $ciclo[fecha_actual] && !in_array($carnet, $habilitarCarnet)) {
                                            $error = true;
                                            $mensaje = "El período de asignación de cursos no se encuentra habilitado, por favor verifique en el calendario oficial. E033.";
                                            $url = "../menus/contenido.php";
                                        } else {
