...
harry.timeline = (function () {
    ...
    var
            ...
            fmtiso55 = function (d) {
                return d.toISOString().substr(5, 5)
            },
            fmttime5 = function (d) {
    ...
    return {
        year: function (s, fnparse, fnfmt) {
            return build(s, 365 * 60 * 60, fnparse || parse, fnfmt || fmtiso55)
        },
        month: function (s, fnparse, fnfmt) {
            return build(s, 31 * 60 * 60, fnparse || parse, fnfmt || fmtiso55)
        },
        week: function (s, fnparse, fnfmt) {
            return build(s, 7 * 24 * 60 * 60, fnparse || parse, fnfmt || fmtiso55)
        },
        day: function (s, fnparse, fnfmt) {
            return build(s, 24 * 60 * 60, fnparse || parse, fnfmt || fmtiso55)
        },
        hour: function (s, fnparse, fnfmt) {
            return build(s, 60 * 60, fnparse || parse, fnfmt || fmttime5)
        },
        minute: function (s, fnparse, fnfmt) {
            return build(s, 60, fnparse || parse, fnfmt || fmttime8)
        },
        second: function (s, fnparse, fnfmt) {
            return build(s, 1, fnparse || parse, fnfmt || fmttime8)
        }
    };
})();