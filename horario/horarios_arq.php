<style>
    ...
    #asignatura_arq_matutina {
        ...
        margin-bottom: 5px;
        color: #045FB4;
        background-image: -webkit-linear-gradient(top, #A9E2F3, #00BFFF);
        background-image: -moz-linear-gradient(top, #A9E2F3, #00BFFF);
        background-image: linear-gradient(#A9E2F3, #00BFFF);
        border: 2px solid #045FB4;
        border-radius: 10px;
    }

    #asignatura_arq_vespertina {
        font-family: Trebuchet MS;
        font-size: 12px;
        width: 130px;
        padding: 2px;
        margin-bottom: 5px;
        color: #5E610B;
        background-image: -webkit-linear-gradient(top, #F3F781, #D7DF01);
        background-image: -moz-linear-gradient(top, #F3F781, #D7DF01);
        background-image: linear-gradient(#F3F781, #D7DF01);
        border: 2px solid #5E610B;
        border-radius: 10px;
    }

    #asignatura_arq_matutina .codigo, #asignatura_arq_matutina .horario, #asignatura_arq_matutina .asignatura {
        font-size: 16px;
    }

    #asignatura_arq_vespertina .codigo, #asignatura_arq_vespertina .horario, #asignatura_arq_vespertina .asignatura {
        font-size: 16px;
    }
    ...
    #tabla {
        ...
        font-size: 20px;
        padding: 3px;
        background-image: -webkit-linear-gradient(top, #A9D0F5, #58ACFA, #A9D0F5);
        background-image: -moz-linear-gradient(top, #A9D0F5, #58ACFA, #A9D0F5);
        background-image: linear-gradient(#A9D0F5, #58ACFA, #A9D0F5);
...
WHERE s.anio = 2014 AND s.semestre = 1 AND s.evaluacion = 1 AND s.extension = 0 AND s.status = 'A'
...
do {
    if ($p1[pensum] == 5 AND $p1[ciclo] == '1') {
        if ($p1[jornada] == 'M') {
            echo "<td><div id=asignatura_arq_matutina><center>
		...
		Disponible: <b>$p1[cupos]</b>
            ...
            echo "<td><div id=asignatura_arq_vespertina><center>
		<b><font class=codigo>$p1[codigo] - $p1[seccion]</b></font><br>
		<font class=asignatura>$p1[nombre]</font><br>
		<font class=horario><b>$p1[hora_ini] - $p1[hora_fin]</b></font><br>
		<b>$p1[docente]</b></center><br>
